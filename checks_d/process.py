...
from common.psutil_wrapper import psutil
...
class ProcessCheck(AgentCheck):
    ...
    def __init__(self, name, init_config, agent_config, instances=None):
        ...
        if process_fs_path_config:
            ...
            print('The path of the process filesystem set to %s', process_fs_path_config)
        else:
            print('The process_fs_path not set. Use default path: /proc')
    ...
    def get_process_metrics(self, pids, name):
        ...
        for pid in set(pids):
            try:
                ...
                if io_permission:
                    try:
                        ...
                        print('monasca-agent user does not have ' +
            ...
            # Skip processes dead in the meantime
                ...
                print('Process %s disappeared while metrics were being collected' % pid)
                pass

        if got_denied:
            print("The Monitoring Agent was denied access " +
    ...
    def prepare_run(self):
        ...
        for process in psutil.process_iter():
            try:
                ...
                print.info('Access denied to process {0}: {1}'.format(
                    process_dict['name'], e))
    ...
    def check(self, instance):
        ...
        print("exact_match : {}".format(exact_match))
