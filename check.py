...
import common.aggregator as aggregator
import common.metrics as metrics_pkg
...
class AgentCheck(util.Dimensions):
    ...
    def run(self):
        ...
        for i, instance in enumerate(self.instances):
            try:
                #self.log.error("HERE agenetcheck run")
                self.check(instance)
            except Exception:
                print("Check '%s' instance #%s failed" % (self.name, i))
